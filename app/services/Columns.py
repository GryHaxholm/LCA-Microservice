...
if 'Column' in structuralElements:
    for column in structuralElements['Column']:
        if column['Material'] == "Concrete":
            if "C20/25" or "C12/15" or "C16/20" in column['Quality']:
